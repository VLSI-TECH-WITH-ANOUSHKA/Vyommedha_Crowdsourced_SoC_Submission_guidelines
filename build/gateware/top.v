...
// Filename   : top.v
// Device     : EP4CE22F17C6
// LiteX sha1 : d2fa6383d
// Date       : 2025-09-01 18:53:56
//------------------------------------------------------------------------------
...
wire    [3:0] csr_bankarray_csrbank2_in_r;
reg           csr_bankarray_csrbank2_in_re = 1'd0;
wire    [3:0] csr_bankarray_csrbank2_in_w;
...
reg     [3:0] multiregimpl10 = 4'd0;
reg     [3:0] multiregimpl11 = 4'd0;
reg           next_state = 1'd0;
wire          por_clk;
...
assign csr_bankarray_csrbank2_sel = (csr_bankarray_interface2_bank_bus_adr[13:9] == 1'd1);
assign csr_bankarray_csrbank2_in_r = csr_bankarray_interface2_bank_bus_dat_w[3:0];
always @(*) begin
...
assign csr_bankarray_csrbank2_in_w = switches_status;
assign switches_we = csr_bankarray_csrbank2_in_we;
...
assign csr_bankarray_csrbank3_load0_w = timer_load_storage;
assign csr_bankarray_csrbank3_reload0_w = timer_reload_storage;
...
assign csr_bankarray_csrbank3_value_w = timer_value_status;
...
always @(*) begin
    ...
    if ((csr_bankarray_csrbank4_sel & (csr_bankarray_interface4_bank_bus_adr[8:0] == 1'd0))) begin
        ...
        uart_rxtx_we <= csr_bankarray_interface4_bank_bus_re;
    end
end
...
assign csr_bankarray_csrbank4_ev_status_w = uart_status_status;
...
assign csr_bankarray_csrbank4_ev_pending_w = uart_pending_status;
assign uart_pending_we = csr_bankarray_csrbank4_ev_pending_we;
assign uart_tx2 = uart_enable_storage[0];
assign uart_rx2 = uart_enable_storage[1];
assign csr_bankarray_csrbank4_ev_enable0_w = uart_enable_storage;
...
assign switches_status = multiregimpl11;
...
always @(posedge sys_clk) begin
    ...
    switches_re <= csr_bankarray_csrbank2_in_re;
    ...
    if (csr_bankarray_csrbank3_load0_re) begin
        timer_load_storage <= csr_bankarray_csrbank3_load0_r;
    end
    timer_load_re <= csr_bankarray_csrbank3_load0_re;
    if (csr_bankarray_csrbank3_reload0_re) begin
        timer_reload_storage <= csr_bankarray_csrbank3_reload0_r;
    end
    ...
    if (csr_bankarray_csrbank4_ev_pending_re) begin
        uart_pending_r <= csr_bankarray_csrbank4_ev_pending_r;
    end
    uart_pending_re <= csr_bankarray_csrbank4_ev_pending_re;
    if (csr_bankarray_csrbank4_ev_enable0_re) begin
        uart_enable_storage <= csr_bankarray_csrbank4_ev_enable0_r;
    end
    ...
    multiregimpl10 <= {sw3, sw2, sw1, sw0};
...
//------------------------------------------------------------------------------
// Memory rom_grain0: 6125-words x 8-bit
//------------------------------------------------------------------------------
// Port 0 | Read: Sync  | Write: ---- | 
reg [7:0] rom_grain0[0:6124];
initial begin
	$readmemh("top_rom_grain0.init", rom_grain0);
end
reg [7:0] rom_grain0_dat0;
always @(posedge sys_clk) begin
	rom_grain0_dat0 <= rom_grain0[adr];
end
assign dat_r[7:0] = rom_grain0_dat0;


//------------------------------------------------------------------------------
// Memory rom_grain1: 6125-words x 8-bit
//------------------------------------------------------------------------------
// Port 0 | Read: Sync  | Write: ---- | 
reg [7:0] rom_grain1[0:6124];
initial begin
	$readmemh("top_rom_grain1.init", rom_grain1);
end
reg [7:0] rom_grain1_dat0;
always @(posedge sys_clk) begin
	rom_grain1_dat0 <= rom_grain1[adr];
end
assign dat_r[15:8] = rom_grain1_dat0;


//------------------------------------------------------------------------------
// Memory rom_grain2: 6125-words x 8-bit
//------------------------------------------------------------------------------
// Port 0 | Read: Sync  | Write: ---- | 
reg [7:0] rom_grain2[0:6124];
initial begin
	$readmemh("top_rom_grain2.init", rom_grain2);
end
reg [7:0] rom_grain2_dat0;
always @(posedge sys_clk) begin
	rom_grain2_dat0 <= rom_grain2[adr];
end
assign dat_r[23:16] = rom_grain2_dat0;


//------------------------------------------------------------------------------
// Memory rom_grain3: 6125-words x 8-bit
//------------------------------------------------------------------------------
// Port 0 | Read: Sync  | Write: ---- | 
reg [7:0] rom_grain3[0:6124];
initial begin
	$readmemh("top_rom_grain3.init", rom_grain3);
end
reg [7:0] rom_grain3_dat0;
always @(posedge sys_clk) begin
	rom_grain3_dat0 <= rom_grain3[adr];
end
assign dat_r[31:24] = rom_grain3_dat0;
...
initial begin
	$readmemh("top_sram_grain0.init", sram_grain0);
end
reg [10:0] sram_grain0_adr0;
always @(posedge sys_clk) begin
	if (sram0_we[0])
		sram_grain0[sram0_adr] <= sram0_dat_w[7:0];
	sram_grain0_adr0 <= sram0_adr;
end
assign sram0_dat_r[7:0] = sram_grain0[sram_grain0_adr0];
...
initial begin
	$readmemh("top_sram_grain1.init", sram_grain1);
end
reg [10:0] sram_grain1_adr0;
always @(posedge sys_clk) begin
	if (sram0_we[1])
		sram_grain1[sram0_adr] <= sram0_dat_w[15:8];
	sram_grain1_adr0 <= sram0_adr;
end
assign sram0_dat_r[15:8] = sram_grain1[sram_grain1_adr0];
...
initial begin
	$readmemh("top_sram_grain2.init", sram_grain2);
end
reg [10:0] sram_grain2_adr0;
always @(posedge sys_clk) begin
	if (sram0_we[2])
		sram_grain2[sram0_adr] <= sram0_dat_w[23:16];
	sram_grain2_adr0 <= sram0_adr;
end
assign sram0_dat_r[23:16] = sram_grain2[sram_grain2_adr0];
...
initial begin
	$readmemh("top_sram_grain3.init", sram_grain3);
end
reg [10:0] sram_grain3_adr0;
always @(posedge sys_clk) begin
	if (sram0_we[3])
		sram_grain3[sram0_adr] <= sram0_dat_w[31:24];
	sram_grain3_adr0 <= sram0_adr;
end
assign sram0_dat_r[31:24] = sram_grain3[sram_grain3_adr0];


//------------------------------------------------------------------------------
// Memory main_ram_grain0: 4096-words x 8-bit
//------------------------------------------------------------------------------
// Port 0 | Read: Sync  | Write: Sync | Mode: Write-First | Write-Granularity: 8 
reg [7:0] main_ram_grain0[0:4095];
initial begin
	$readmemh("top_main_ram_grain0.init", main_ram_grain0);
end
reg [11:0] main_ram_grain0_adr0;
always @(posedge sys_clk) begin
	if (sram1_we[0])
		main_ram_grain0[sram1_adr] <= sram1_dat_w[7:0];
	main_ram_grain0_adr0 <= sram1_adr;
end
assign sram1_dat_r[7:0] = main_ram_grain0[main_ram_grain0_adr0];


//------------------------------------------------------------------------------
// Memory main_ram_grain1: 4096-words x 8-bit
//------------------------------------------------------------------------------
// Port 0 | Read: Sync  | Write: Sync | Mode: Write-First | Write-Granularity: 8 
reg [7:0] main_ram_grain1[0:4095];
initial begin
	$readmemh("top_main_ram_grain1.init", main_ram_grain1);
end
reg [11:0] main_ram_grain1_adr0;
always @(posedge sys_clk) begin
	if (sram1_we[1])
		main_ram_grain1[sram1_adr] <= sram1_dat_w[15:8];
	main_ram_grain1_adr0 <= sram1_adr;
end
assign sram1_dat_r[15:8] = main_ram_grain1[main_ram_grain1_adr0];


//------------------------------------------------------------------------------
// Memory main_ram_grain2: 4096-words x 8-bit
//------------------------------------------------------------------------------
// Port 0 | Read: Sync  | Write: Sync | Mode: Write-First | Write-Granularity: 8 
reg [7:0] main_ram_grain2[0:4095];
initial begin
	$readmemh("top_main_ram_grain2.init", main_ram_grain2);
end
reg [11:0] main_ram_grain2_adr0;
always @(posedge sys_clk) begin
	if (sram1_we[2])
		main_ram_grain2[sram1_adr] <= sram1_dat_w[23:16];
	main_ram_grain2_adr0 <= sram1_adr;
end
assign sram1_dat_r[23:16] = main_ram_grain2[main_ram_grain2_adr0];


//------------------------------------------------------------------------------
// Memory main_ram_grain3: 4096-words x 8-bit
//------------------------------------------------------------------------------
// Port 0 | Read: Sync  | Write: Sync | Mode: Write-First | Write-Granularity: 8 
reg [7:0] main_ram_grain3[0:4095];
initial begin
	$readmemh("top_main_ram_grain3.init", main_ram_grain3);
end
reg [11:0] main_ram_grain3_adr0;
always @(posedge sys_clk) begin
	if (sram1_we[3])
		main_ram_grain3[sram1_adr] <= sram1_dat_w[31:24];
	main_ram_grain3_adr0 <= sram1_adr;
end
assign sram1_dat_r[31:24] = main_ram_grain3[main_ram_grain3_adr0];


endmodule

// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2025-09-01 18:53:56.
//------------------------------------------------------------------------------
